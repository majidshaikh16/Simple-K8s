...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.main.SimpleWeb.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                .title("Web Client")
                .description("This page lists all the rest apis for K8's client")
                .version("1.0.0")
                .license("Majid Shaikh")
                .contact(contact)
                .build();
    }
}
